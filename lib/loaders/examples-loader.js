...
function examplesLoader(source) {
  ...
  const updateExample = config.updateExample ? props => config.updateExample(props, this.resourcePath) : undefined;
  ...
  const requireContextCode = _astTypes.builders.program((0, _flatten.default)((0, _map.default)(fullContext, _resolveESModule.default)));
