...
var TableOfContents = /*#__PURE__*/function (_Component) {
  ...
  _proto.renderLevel = function renderLevel(sections, useRouterLinks, hashPath, useHashId) {
    ...
    var _ref = (_this$props$loc = this.props.loc) != null ? _this$props$loc : window.location,
      hash = _ref.hash,
    ...
    var processedItems = sections.map(function (section) {
      ...
      var _ref2 = children.length > 0 ? _this2.renderLevel(children, useRouterLinks, childHashPath, sectionDepth === 0) : {
          content: undefined,
          containsSelected: false
        },
        content = _ref2.content,
        containsSelected = _ref2.containsSelected;
  ...
  _proto.renderSections = function renderSections() {
    ...
    var firstLevel = sections.length === 1 ?
